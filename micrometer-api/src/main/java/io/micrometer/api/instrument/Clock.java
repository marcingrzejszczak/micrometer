...
public interface Clock {
     ...
     * timestamping metrics being pushed to a monitoring system or for determination
     * of step boundaries.
     *
     ...
     * compared with another snapshot to determine the elapsed time for an
     * operation. The difference between two samples will have a unit of
     * nanoseconds. The returned value is typically equivalent to System.nanoTime.
     *
