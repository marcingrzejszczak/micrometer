...
/**
 * An immutable collection of {@link Tag Tags} that are guaranteed to be sorted
 * and deduplicated by tag key.
 *
...
public final class Tags implements Iterable<Tag> {
    ...
    /**
     * Return a new {@code Tags} instance by merging this collection and the
    ...
    /**
     * Return a new {@code Tags} instance by concatenating the specified collections
     * of tags.
     *
    ...
    /**
     * Return a new {@code Tags} instance containing tags constructed from the
