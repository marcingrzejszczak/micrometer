...
/**
 * A Recording represents an observation of an {@link Event}. It can give you
 * details about the occurrence of an {@link Event}, see the implementations for
 * details.
 *
 ...
 * @since 6.0.0
 * @param <E> event type
 * @param <R> recording Type // * @see InstantRecording
...
public interface Recording<E extends Event, R extends Recording<E, R>> {
     ...
     * {@link Event#getLowCardinalityName()}, this method can return
     * high-cardinality values and can be overwritten on-the-fly.
     *
