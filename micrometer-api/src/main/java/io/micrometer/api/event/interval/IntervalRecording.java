...
public interface IntervalRecording extends Recording<IntervalEvent, IntervalRecording>, AutoCloseable {
    ...
    /**
     * The start time in nanos. The value is only meaningful when compared with
    ...
    /**
     * The stop time in nanos. The value is only meaningful when compared with
     * another value to determine the elapsed time.
     *
     ...
     *
     * @param wallTime      the wall time (system time) in nanoseconds since the
     *                      epoch at the time the event started
     * @param monotonicTime the start time in nanos. The value is only meaningful
     *                      when compared with another value to determine the
     *                      elapsed time
     * @return itself
     */
     ...
     *
     * @param monotonicTime the stop time in nanos. The value is only meaningful
     *                      when compared with another value to determine the
     *                      elapsed time
     */
    ...
    /**
     * Returns the context object for the actual listener in case you need to pass
     * data between listener methods.
     *
